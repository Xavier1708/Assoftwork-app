...
<body>
    ...
    <header class="navbar  sticky-bottom  flex-md-nowrap p-0 shadow">
      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Painel Adminstrativo</h1>
          ...
          <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="669" height="182" style="display: block; width: 669px; height: 62px;"></canvas>

          <h2>Numeros por clientes</h2>
          <div class="table-responsive ">
            <table class="table table-striped table-sm no-visible">
              <thead>
                <tr>
                  <th scope="col">#</th>
